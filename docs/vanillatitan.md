...
修复离子在未手持主武器的情况下 瞄准/取消瞄准 时再换回主武器会导致主武器的 瞄准/取消瞄准 函数没有被运行，会出现伤害和特效异常的问题
...
浪人剑核心开启时每当挥剑一次都减少2.5秒核心剩余时间

浪人装备"高地战士"：核心期间每挥剑一次只减少1.5秒核心剩余时间
...
帝王升级顺序为先升级你选择的三个自定义升级，随后按照顺序每两个核心升级一次直到九级

> 升级时遇到已经升级的升级会直接跳到下一个升级

帝王涡旋电烟对非装甲单位dps 90 -> 60 对装甲单位dps 1350 -> 800

帝王XO16的加速器升级不再对伤害进行增大，对装甲单位伤害近距离 120 -> 100 远距离 100 -> 80
