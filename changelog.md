...
## 12.9 LTS
  ...
  - 修复原版bug：离子在未手持主武器的情况下瞄准/取消瞄准时再换回主武器会导致主武器的瞄准/取消瞄准函数没有被跑到并导致伤害，特效异常的问题

  - 增大训牛有效范围，训牛离开不再继承训牛泰坦的速度

  - 提高离机速度，不按方向键离机时无xy轴速度改为当没按下方向键时离机默认认为按下了-y方向（即为：朝后）

  - 隆重悼念Stable服务器，享年几个小时就觉得还不如开个纯ttdm就关了几把的一点也不好玩

## 12.8

  - Stable服务器回归，为其选了个清晰的爽服定位
  ...
  - 修复执政官主武器蓄能时莫名有0.6秒硬直的问题（不是谁给执政官主武器写的0.6秒换弹时间什么几把玩意）

  - 修复执政官在NPC泰坦情况下可以无视充能时间想射就射

  - gui交付失败时关闭前不会更改选择的元素

  - 野兽四号技能组大调整，降低能造成的伤害提升恢复速度
